...
<br>
<br>過去10年中，AI取代醫生工作已經有重大進展，對改善醫生生活品質和醫療品質有莫大幫助。10年前醫生工作完全不受國定假日影響，現在許多醫生卻能在國定假日放假，有些甚至能在春節前後享有連假。這10年，醫生平均每周工時從188小時降到106小時，平均連續值班工時也從38小時降到29小時。減少連續值班30小時以上的情況，除了降低醫生過勞死危險之外，也對病人的醫療品質有很大幫助。現行的勞基法能夠保障一部分年輕醫生，也要歸功於AI自動化技術降低了那一小部分醫生的工作量，使勞基法在他們身上變可行。
<br>
...
<br>
<br>上上週末有一篇研究報告指出，GPT-4在台灣二階醫師國考中的正確率高達90.9% (60.0%及格)，這是一個非常令人印象深刻的成就。然而，這項研究成果距離臨床應用仍很遙遠。醫師國考都是選擇題，但是臨床應用時並不會有人提供選項。另外，醫師國考的題幹敘述大部分也不是醫療情境，而是被出題老師選擇要測驗學生的知識。因此，醫師國考的題目與臨床實務之間可能存在差異。此外，醫師國考的題目通常是單一疾病或單一病徵，而臨床實務中的病人可能有多種疾病或病徵，因此需要更多的判斷和分析。
<br>
...
<br>
<br>每題讓2個ChatGPT、2位四年級醫學生、2位五年級醫學生、1位六年級醫學生、1位已完成GPY即將接受專科醫師訓練的醫生、1位大腸直腸外科主治醫生、1位胸腔外科主治醫師回答，並計算分數。其中2個ChatGPT分別是ChatGPT和ChatGPT+Bing。
<br>
...
<br>Example 2: Terazosin is an α-1 adrenergic receptor antagonist that was initially used to treat hypertension (↓ vasoconstriction → ↓ blood pressure) and was later found to be useful for treating BPH as well (relaxation of bladder neck muscles → ↓ bladder outlet obstruction and easier micturition). 
...
<br>問答題可以測試對學科的深入理解和創造力，但也需要更多時間和精力來準備和改卷。在本研究中，我使用光穎分數和冠元分數2個評分標準來評分。選擇題可以測試學生對基本知識和技能的掌握，但也可能出現模稜兩可、誘答性或猜測等問題。
<br>相對於考試內容較基礎的考試，考試內容較臨床的考試可以更好地測試醫學推理能力。這是因為臨床考試通常涉及更多的情境和真實世界的問題，需要考生在不同的情況下應用他們的知識和技能。此外，臨床考試還可以幫助學生更好地理解醫學知識和實際應用之間的關係。
<br>問答題通常比選擇題更能測試學生的醫學推理能力。這是因為問答題需要學生在不同的情況下應用他們的知識和技能，並在回答問題時提供更多的細節和解釋。此外，問答題還可以幫助學生更好地理解醫學知識和實際應用之間的關係。
<br>相反，選擇題通常只需要學生從一組選項中選擇正確答案。雖然這些題目可以測試學生對基本概念的理解，但它們不能測試學生在真實情況下應用這些概念的能力。
<br>這個系統可以提供客觀和一致的標準來測試醫學實力，避免人為主觀或偏差、增加醫學生或醫師對理學檢查的興趣和信心，並促進其學習和提升、幫助醫學院或醫院發現並改善理學檢查方面的不足或缺陷，並提高其教育或服務品質以及測試人工智慧模型的判斷能力並和醫師和醫學生進行比較。
<br>過去的研究主要比較人類考生和人工智慧模型在醫師國考的表現，而本研究則使用了一個可以提供客觀和一致的標準的問答題系統來測試醫學實力。這個問答題系統可以提供一個公平的環境，讓所有參與者都接受相同的考試，並且更能模擬臨床實境，可以更好地測試參與者的醫學知識和技能。
<br>本研究發現，住院醫師階段是醫學通才能力的高峰，主治醫師階段則有衰退的趨勢。這個結果與前人的研究相符，顯示本研究的評分系統具有良好的效度。
<br>
<br>其中在滿分40分的10題測驗中，ChatGPT+Bing比ChatGPT的光穎分數高了7分。ChatGPT+Bing是指微軟（Microsoft）將其新版Bing（必應）搜尋服務加入了ChatGPT技術，讓用戶可以透過Bing聊天（Bing Chat）與機器人互動或搜尋資訊。ChatGPT是一種基於OpenAI的大型語言模型GPT-3.5的AI聊天機器人，可以產生流暢和有趣的對話。
<br>ChatGPT+Bing是基於Prometheus模型，Prometheus模型的工作流程如下：
<br>- 使用者輸入問題或關鍵字
<br>- ChatGPT將問題或關鍵字轉換為適合Bing搜尋的查詢
<br>- Bing Orchestrator根據查詢從Bing提供的Index, Ranking & Answers中選擇最佳的答案
<br>- Bing Orchestrator將答案傳回給ChatGPT，並生成一個友好、自然和有用的回覆
<br>- ChatGPT將回覆傳回給使用者
<br>可能有以下幾個原因造成ChatGPT+Bing比ChatGPT的光穎分數高了7分：
<br>- ChatGPT+Bing可以利用Bing的網路資源來回答更多和更準確的問題，而不僅僅依賴自己的內部知識或記憶。
<br>- ChatGPT+Bing可以根據用戶的語言和地區來適當地調整回答的內容和風格，而不是只使用英語或美式文化。
<br>- ChatGPT+Bing可以利用微軟的安全和隱私保護措施來避免回答不恰當或有害的問題，而不是隨意產生可能引起爭議或困惑的回答。
<br>Bing不搜尋時給出的答案平均光穎分數較高。這可能是因為搜索詞語不夠明確或者搜索詞語與實際想要的答案不太相關。此外，有時候搜索結果可能會過於廣泛或者過於專注於某一方面，而沒有提供所需的具體信息，因此降低光穎分數。
<br>
<br>在嘗試in-context learning、instruction-tuning、建議Chain-of-thought promptimg、強制Chain-of-thought promptimg等prompt後，我發現在醫療輔助診斷任務上，多個無標註的in-context learning勝於少個精心設計的範例。這可能是因為in-context learning可以讓模型從多個相關的示例中學習(或喚醒)到更多的知識和技能，而少個範例可能無法涵蓋所有可能的情境和變化。Chain-of-thought promptimg(強制)普遍在ChatGPT幫助不大。這可能是因為Chain-of-thought promptimg是一種利用自然語言指令來引導模型完成特定任務的方法，而強制使用這種方法可能會限制模型的自由度和靈活性，或者與模型本身的語言能力不匹配，也可能是因為ChatGPT本身就自帶chain-of-thought傾向，即使有prompt進步幅度也不大。這也表示日後用ChatGPT進行醫療輔助診斷任務成本極低，不用人工標註答案。
<br>
<br>另外，我在此提出新的提示方法「Spraget prompting」，能夠讓擅長作答選擇題的聊天機器人用選擇題方式作答問答題。這種提示方法的名稱來自於其創始人的朋友的前偶像，也是前國際將軍棋大賽(generals.io)冠軍，他的名字是「Spraget」。這種提示方法的基本思想是將問答題轉換為選擇題，然後讓聊天機器人作答選擇題。
<br>這種提示方法的實現方式是將問答題轉換為選擇題。具體來說，對於一個問答題，聊天機器人會根據問題和相關資料庫中的信息生成幾個可能的答案，然後將這些答案作為選項列出來，讓聊天機器人從中選擇正確的答案。ChatGPT的訓練過程是基於大量的文本數據，因此它可以生成與輸入問題相關的選項。ChatGPT可以通過以下步驟為問答題產生選項，使之變為選擇題：
<br>1. 首先，將問答題轉換為多個子問題。
<br>2. 然後，對於每個子問題，使用ChatGPT生成幾個可能的答案。
<br>3. 最後，將這些答案作為選項提供給聊天機器人。
<br>這種提示方法的優點是可以讓聊天機器人更快地作答問答題，並且可以減少聊天機器人作答問答題時出現錯誤的可能性。
<br>需要注意的是，這種提示方法只能用於那些可以轉換為選擇題的問答題。如果一個問答題不能轉換為選擇題，那麼這種提示方法就無法使用了。
<br>使用這種提示方法產生的答案和論述可以用冠萭分數(Spraget score)評分。
<br>但因成本考量，本研究並未使用此方法，留給未來研究使用。
<br>
...
<br>- ChatGPT利用了GPT-4強大的語言知識和常識推理能力，從大量的文本數據中學習到了一些醫學相關的信息。
<br>- ChatGPT通過自然語言生成技術，根據用戶提供的症狀和病史，生成了合理和流暢的診斷結果和建議。
<br>
<br>本研究因成本考量，有這些限制：
<br>- 本研究未計算P值和顯著性，因為樣本(回收考卷數)少。
<br>- 本研究未算出冠元分數和冠萭分數，因為人力不足。但是未來可以用冠元分數和冠萭分數評估機器學習的成效。由於本研究未使用冠元分數和冠萭分數，未來使用冠元分和冠萭分數數可避免古德哈特定律(Goodheart’s law)。古德哈特定律是指當一個指標被用作目標時，它將不再是一個好的指標。這是因為人們會開始利用各種手段來改變結果，以達到他們的目的。當指標的效度非完美時，AI也會overfit到指標而無法接近無法描述的objective function。
<br>- 本研究僅對ChatGPT的醫學推理能力做了初步測試，以展示它有取代醫生部分工作的潛力，若要用於輔助診斷仍有很多能讓AI進步的方法。
<br>
...
<br>- 選擇一個適合任務的基礎模型，例如text-davinci-003
<br>- 準備一個包含輸入和目標輸出的數據集，例如本研究的15道例題
<br>- 使用Fine-tuning API或其他工具來創建一個新的模型實例，並指定基礎模型和數據集
<br>- 設置微調的超參數，例如學習率、批次大小、迭代次數等
<br>- 啟動微調過程，並監測模型的訓練進度和性能指標
<br>- 保存和測試微調後的模型，並根據需要進行調整或部署
...
<br>- 它可以自然地處理不確定性和多模態性，並且可以生成高質量和多樣性的數據。
<br>- 它可以利用大量的無監督數據進行預訓練，並通過少量的監督數據進行微調，提高模型的泛化能力和數據效率。
<br>- 它可以通過一個簡單而有效的採樣算法來生成數據，並且可以方便地與其他生成模型結合使用。
<br>gpt是一種基於變換器（transformer）架构的自回歸語言模型，它可以通過深度學習從大量文本中學習語言知識，並且可以根据輸入文本生成人類般的文本。gpt相較於diffusion model有以下好處：
<br>- 它可以利用更大規模和更豐富多元的文本數據進行預訓練，提高模型對語言知識和常識推理能力。
<br>- 它可以通過少量或無監督數據進行zero-shot或few-shot學習，在沒有任何參數微調或修改的情況下完成不同任務。
<br>- 它可以通過變換器架构實現高效率和可拓展性，在GPU或TPU上快速訓練和推理。
<br>
<br>Non-autoregressive (NAR) model相較於autoregressive (AR) model有以下好處：
<br>- 它可以實現更快的生成速度，因為它不需要等待前一個元素的生成結果。
<br>- 它可以減少生成過程中的錯誤累積，因為它不依賴於前一個元素的正確性。
<br>- 它可以更容易地處理長序列和多模態數據，因為它不受記憶體和注意力機制的限制。
...
<br>- 醫學通才可以更好地滿足多樣化和複雜化的人口健康需求，特別是對於多發病、老年人、偏遠地區和弱勢群體。
<br>- 醫學通才可以更有效地利用有限的衛生資源，減少不必要的轉診、檢查和治療，提高衛生系統的效率和質量。
<br>- 醫學通才可以更容易地與其他專業人員合作，建立團隊精神和信任關係，促進跨領域和跨界別的溝通和協作。
<br>但醫生常在專精於狹窄領域時逐漸失去通才能力。此時ChatGPT衍生的輔助工具就可能派上用場。
<br>
<br>一直以來，在醫療領域，深度學習都只在影像辨識有用武之地，其他AI都以決策樹為主。
<br>深度學習相較於決策樹，可能有以下幾個優勢：
<br>- 深度學習可以處理更複雜和高維度的數據，例如影像、語音、文字等。
<br>- 深度學習可以適應更多變化和噪聲的數據，例如旋轉、平移、模糊等。
<br>- 深度學習可以提升更高的準確率和泛化能力，在許多領域都超越了傳統的方法。
<br>決策樹相較於深度學習，可能有以下幾個優勢：
<br>- 決策樹可以處理不同類型和格式的數據，例如數值型、類別型、缺失值等。
<br>- 決策樹可以生成清晰和可解釋的規則，方便人們理解和驗證。
<br>- 決策樹可以節省計算資源和時間，在訓練和測試時都比深度學習快速。
<br>所以，在醫療領域中，
<br>- 當需要處理大量複雜且非結構化的數據時（例如影像辨識），深度學習可能會比決策 樹更適合使用
<br>- 當需要生成可解釋且易於操作的規則時（例如診斷分流），決策 樹可能會比深度學 習更適合使用
...
<br>- 醫生過度依賴AI可能會降低自己的臨床技能和判斷力，因為缺乏實際操作和思考的機會。
<br>- 醫生過度依賴AI可能會忽略病人的個別差異和心理需求，因為過分相信AI的數據和建議而忽視人性化的溝通和關懷。
<br>- 醫生過度依賴AI可能會增加醫療風險和責任，因為AI並非萬能且不可錯誤，如果發生AI失靈或誤判的情況，醫生可能無法及時發現或處理。
<br>我們可以推測，在未來的醫療領域中，
<br>- 醫生需要保持對AI的合理使用和監督，並不斷更新自己的知識和技能。
<br>- 醫生需要重視與病人的互動和信任，並尊重病人的意願和權利。
<br>- 醫生需要明確自己與AI之間的角色和責任，並遵守相關的法律和道德規範。
<br>若使用得當，AI對醫療品質貢獻可期，例如：
<br>- AI可以協助醫師更快速且精準地判讀病症，例如利用影像辨識技術來分析X光片、CT掃描或MRI等、用生成式AI產生診斷和治療建議等(本研究)。
<br>- AI可以提供文字及語意辨識服務，促進醫病關係、提升醫療品質，例如利用自然語言處理技術來生成或整理病歷、報告或處方等。
<br>- AI可以減少醫生的行政負擔和錯誤風險，讓他們專注在核心的臨床工作上，例如利用流程機器人或智慧供應鏈系統來自動化或優化一些重複性或低附加價值的工作。
<br>- AI可以提供臨床決策支援和個人化治療建議，讓醫生能夠根據最新的數據和證據來制定最適合的治療方案，例如利用深度學習技術來分析大量的健康資料庫或基因資料等。
<br>- AI可以延伸醫療服務的場域和範圍，讓病人能夠在家中或社區中接受更方便和即時的醫療服務，例如利用遠距監測、AI示警系統、虛擬助理等技術來實現遠距健康照護。
<br>但是，未來在AI成功取代醫生工作之前，可能先面臨以下挑戰：
<br>- AI在醫療領域的監管與標準化。AI在醫療領域的應用涉及人類的健康與生命，因此需要嚴格的監管與標準化，以確保其安全性、準確性和可靠性。不同國家或地區可能有不同的法規或規範，例如美國的FDA、歐盟的CE等。這對於AI開發者和提供者來說，是一個需要克服的挑戰。
<br>- AI在醫療領域的數據相容性與跨平台應用服務相容性。AI在醫療領域的發展依賴於大量且高品質的數據，但不同來源或格式的數據可能難以整合或共享，造成數據孤島或資訊落差。此外，不同平台或系統之間可能也存在相容性問題，使得AI解決方案難以導入或運作。
<br>- AI在醫療領域的人才缺乏與知識落差。AI在醫療領域需要具備跨領域知識和技能的人才，包括ICT、生物醫學、臨床等方面。然而，這類人才目前仍然相當稀缺，而且需要持續學習和更新知識。此外，在醫師、病人和AI之間也可能存在知識落差或信任問題，影響AI在醫療領域的接受度和效果。
<br>為了讓AI順利取代醫生工作，我們需要多方面的努力和合作，例如：
<br>- 建立AI在醫療領域的監管與標準化機制，以確保其品質、效能和倫理。這需要政府、產業、學術和社會各界的參與和協調。也需要與國際間進行對話和交流，以促進AI在醫療領域的全球合作。
<br>- 建立AI在醫療領域的數據相容性與跨平台應用服務相容性標準，以促進數據的整合、共享和利用。這需要建立一個安全、開放、可信賴的數據平台，並採用適當的技術如雲端、區塊鏈等。
<br>- 建立AI在醫療領域的人才培育和知識傳播機制，以提升人才供給和知識水平 。這需要加強跨領域的教育和訓練，並提供持續學習和更新知識的機會。也需要加強對醫師、病人和公眾的宣導和引導，以增加對AI在醫療領域的信任和接受度。
<br>- 加強對某些害怕AI取代工作的醫學生的教育，減少他們不必要的恐慌，讓他們瞭解即使某些醫生工作被取代，仍不影響醫生的身分、地位和職責。醫生應該盡力完成還沒被取代的工作。就算在醫學系學的技術未來可能完全被取代而派不上用場，學生也要秉持活到老學到老的精神，不斷學習符合時代需求的能力。
<br>
<br>ChatGPT是一種人工智慧聊天機器人，可以根據使用者的輸入產生自然語言的回應。ChatGPT使用微軟伺服器來計算，因此有一些資訊安全或隱私考量。根據OpenAI的官方網站，ChatGPT會將使用者的輸入作為訓練資料，以改善其模型的效能和準確性。這意味著使用者可能會無意間將個人資料或敏感資訊透露給OpenAI，而OpenAI可能會將這些資料與其他組織或個人共享或出售。此外，ChatGPT也可能會產生一些不適當或有害的內容，例如歧視、暴力、色情等，這可能會違反使用者所在地區的法律或道德規範。
<br>為了解決這些資訊安全或隱私考量，OpenAI在2023年4月推出了一些新的功能和控制項。其中一個功能是讓使用者可以關閉他們的聊天歷史，防止他們的輸入被用於訓練資料。另一個功能是讓使用者可以匯出他們的資料副本，以了解OpenAI保存了哪些資訊。此外，OpenAI也預計在未來幾個月推出一個新的商業訂閱方案，該方案將預設不使用使用者的資料作為訓練資料，並提供更多的資料控制和管理選項。
<br>除了OpenAI自身的改善之外，也有一些第三方組織或工具提供了一些解決方案，以增強ChatGPT的資訊安全或隱私保護。例如，Private AI推出了PrivateGPT，一種專為大型語言模型設計的隱私層，可以自動從使用者的輸入中刪除敏感資訊和個人身分識別資訊，並用佔位符取代它們，然後再將去識別化的輸入提交給ChatGPT。另一個例子是Cado Security推出了Masked-AI，一種開源工具，也可以遮罩使用者輸入中的敏感資料，例如姓名、信用卡號碼、電子郵件地址、電話號碼、網址和IP地址等。
<br>
<br>雖然大部分的醫生看到ChatGPT如此優秀的表現會感到興奮，卻也有一些醫生感到害怕。為了避免你看到本研究感到害怕，我要特別釐清一下關於AI取代醫生工作的誤解。
<br>醫生害怕AI的原因可能有多種，不過我想最主要的是對AI的不瞭解和不信任。許多人可能誤以為本研究敘述的AI取代醫生的工作就會害醫生失業，或者擔心AI會做出錯誤的判斷和建議。其實，AI在醫療領域的應用並不是要害醫生失業，而是要協助醫生提高效率、精準度和品質。
<br>根據一些報告和研究，AI可以幫助醫生減少行政負擔、降低錯誤事件、提升生產力、增加病人端的承擔責任等。AI也可以在預防、診斷、治療、長期照護等階段提供數據分析、決策支援、遠距監測等功能。
<br>當然，AI也不是萬能的，它還需要人類醫生的監督、指導和評估。 AI也有其局限性和挑戰，例如資料品質、安全性、隱私性、可解釋性等問題。
<br>因此，我認為醫生不必害怕AI，而是要學習如何與AI合作，發揮各自的優勢和補足各自的缺點。這樣才能創造更好的醫療服務和效果。
<br>
<br>另外，本研究敘述的AI取代醫生工作僅是對醫生而言減輕工作負擔、提升準確性和效率，一般民眾請勿胡亂把AI直接當成醫生，因為這和把Google直接當成醫生一樣，可能會有以下幾種後果：
<br>- 可能會忽視真正的醫生的專業知識和診斷，導致錯誤的治療或延誤就醫。
<br>- 可能會過度依賴AI的建議，而不考慮自己的身體狀況和個別差異，造成不必要的檢查或治療。
<br>- 可能會遭遇AI的錯誤或不完善，例如資料不足、演算法有偏差、無法處理複雜或罕見的情況等，影響判斷和決策。
<br>- 可能會違反醫療倫理和法律，例如侵犯個人隱私、濫用藥物、未經同意進行實驗等。
